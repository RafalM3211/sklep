        ...
        <div class="section-one">
            <nav>
                ...
                <ul class="menu">
                    ...
                    <a href="search.php" target="_blank"><li>wyszukaj</li></a>
                    <li>
                        <form class="search" action="search.php" method="POST" >
                            <input type="text" name="search-text" placeholder="Wyszukaj" size="6"/>
                            <label>
                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24" ><path d="M19.023 16.977a35.13 35.13 0 0 1-1.367-1.384c-.372-.378-.596-.653-.596-.653l-2.8-1.337A6.962 6.962 0 0 0 16 9c0-3.859-3.14-7-7-7S2 5.141 2 9s3.14 7 7 7c1.763 0 3.37-.66 4.603-1.739l1.337 2.8s.275.224.653.596c.387.363.896.854 1.384 1.367l1.358 1.392.604.646 2.121-2.121-.646-.604c-.379-.372-.885-.866-1.391-1.36zM9 14c-2.757 0-5-2.243-5-5s2.243-5 5-5 5 2.243 5 5-2.243 5-5 5z"></path></svg>
            ...
            <header> 
                <div class="video-background">
                  <video src="public/image/film.mp4" type="video/mp4" muted="no" autoplay loop ></video>
                </div>
        ...
        <div class="section-two">
            <div id="news">
                <section class="section">
                    <div class="container">
                        <h2>O firmie...</h2>
                        <p>W Lublińcu, gdzie życie tętniło rytmem nowoczesności, czterej przyjaciele – Kamil, Rafał, Patryk i Maciej – zainspirowani wspólną miłością do sztuki destylacji postanowili połączyć siły i stworzyć coś wyjątkowego. Każdy z nich wnosił coś unikatowego do tego partnerstwa: Kamil – kreatywność i wyrafinowany gust, Rafał – niezrównane umiejętności techniczne, Patryk – pasję do historii i tradycji, a Maciej – nieustępliwość w dążeniu do perfekcji.</p>
                    </div>

                    <div class="gallery">
                        <a href="./public/image/gallery/photo1.jpg" data-lightbox="LcGallery" data-title="Drink"><img src="./public/image/gallery/photo1.jpg"></a>
                        <a href="./public/image/gallery/photo2.jpg" data-lightbox="LcGallery" data-title="Drink"><img src="./public/image/gallery/photo2.jpg"></a>
                        <a href="./public/image/gallery/photo3.jpg" data-lightbox="LcGallery" data-title="Drink"><img src="./public/image/gallery/photo3.jpg"></a>
                        <a href="./public/image/gallery/photo4.jpg" data-lightbox="LcGallery" data-title="Drink"><img src="./public/image/gallery/photo4.jpg"></a>
                        <a href="./public/image/gallery/photo5.jpg" data-lightbox="LcGallery" data-title="Drink"><img src="./public/image/gallery/photo5.jpg"></a>
                        <a href="./public/image/gallery/photo6.jpg" data-lightbox="LcGallery" data-title="Drink"><img src="./public/image/gallery/photo6.jpg"></a>
                        <a href="./public/image/gallery/photo10.jpg" data-lightbox="LcGallery" data-title="Drink"><img src="./public/image/gallery/photo10.jpg"></a>
                        <a href="./public/image/gallery/photo8.jpg" data-lightbox="LcGallery" data-title="Drink"><img src="./public/image/gallery/photo8.jpg"></a>
                        <a href="./public/image/gallery/photo9.jpg" data-lightbox="LcGallery" data-title="Drink"><img src="./public/image/gallery/photo9.jpg"></a>
                    </div>
                </section>
            </div>
          ...
          <svg id="wave" style="transform:rotate(0deg); transition: 0.3s; background-color: #fff;" viewBox="0 0 1440 490" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <defs>
